...
```
# windows
docker run -d --name my-mysql -p 3306:3306 --privileged=true --restart=always -v E:/mysql/data:/var/lib/mysql -v E:/mysql/conf:/etc/mysql/conf.d -v E:/mysql/logs:/var/log/mysql -e MYSQL_ROOT_PASSWORD=123456 mysql:8
